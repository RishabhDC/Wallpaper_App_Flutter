...
class AllWalpaper extends StatefulWidget {
  String category;

   AllWalpaper({required this.category});

  @override
  State<AllWalpaper> createState() => _AllWalpaperState();
}

class _AllWalpaperState extends State<AllWalpaper> {
